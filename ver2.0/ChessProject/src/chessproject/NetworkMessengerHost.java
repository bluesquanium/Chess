...
public class NetworkMessengerHost {
	protected JTextField textField;
	protected JTextArea textArea;
	DatagramSocket socket;
	DatagramPacket packet;
	InetAddress address = null;
	final int myPort = GameData.MESSENGER_HOST_PORT;
	final int otherPort = GameData.MESSENGER_CLIENT_PORT;
	
	public NetworkMessengerHost( String _opponent_address ) throws IOException {
